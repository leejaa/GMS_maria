          ...
          <div class="jumbotron">
            <div class="row">
                ...
                <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                    ...
                    <div class="col-md-8">  
                    <ul class=" details">
                     <li><p id="member_id"><span class="glyphicon glyphicon-credit-card one" style="width:50px;visibility: hidden;"></span><span style="visibility: hidden;">${requestScope.student.member_id}</span></p></li>
                      ...
                      <li><p id="name"><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>${requestScope.student.name}</p></li>
